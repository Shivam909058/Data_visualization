...
if uploaded_file is not None:
    ...
    with col2:
        ...
        plot_list = ['Line Plot', 'Bar Chart', 'Scatter Plot', 'Distribution Plot', 'Count Plot', 'Box Plot',
                     'Violin Plot', 'Pair Plot', 'Heatmap', 'KDE Plot', 'Joint Plot', 'Swarm Plot', 'Point Plot',
                     'Strip Plot']
